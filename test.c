...
void testthedoorclose() {
    drawChar(0, 64, 'D', BLUE, BLUE, 2);
    drawChar(10, 64, 'o', BLUE, BLUE, 2);
    drawChar(20, 64, 'o', BLUE, BLUE, 2);
    drawChar(30, 64, 'r', BLUE, BLUE, 2);
    drawChar(50, 64, 'i', BLUE, BLUE, 2);
    drawChar(60, 64, 's', BLUE, BLUE, 2);
    drawChar(80, 64, 'C', BLUE, BLUE, 2);
    drawChar(90, 64, 'l', BLUE, BLUE, 2);
    drawChar(100, 64, 'o', BLUE, BLUE, 2);
    drawChar(110, 64, 's', BLUE, BLUE, 2);
    drawChar(120, 64, 'e', BLUE, BLUE, 2);
    drawChar(127, 64, 'd', BLUE, BLUE, 2);
}

void testthedooropen(){
    drawChar(0, 64, 'D', BLUE, BLUE, 2);
    drawChar(10, 64, 'o', BLUE, BLUE, 2);
    drawChar(20, 64, 'o', BLUE, BLUE, 2);
    drawChar(30, 64, 'r', BLUE, BLUE, 2);
    drawChar(50, 64, 'i', BLUE, BLUE, 2);
    drawChar(60, 64, 's', BLUE, BLUE, 2);
    drawChar(80, 64, 'O', BLUE, BLUE, 2);
    drawChar(90, 64, 'p', BLUE, BLUE, 2);
    drawChar(100, 64, 'e', BLUE, BLUE, 2);
    drawChar(110, 64, 'n', BLUE, BLUE, 2);
    drawChar(120, 64, 'e', BLUE, BLUE, 2);
    drawChar(127, 64, 'd', BLUE, BLUE, 2);
